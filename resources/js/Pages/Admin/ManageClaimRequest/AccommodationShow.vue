    ...
    router.put(route('admin.manage.claim-request.approve', {
        ...
        onSuccess: () => {
            toast.add({
                severity: "success",
                summary: "Approved",
                detail: "Accommodation claim approved successfully",  // Fixed message
                life: 3000,
            });
...
<template>
    ...
    <AppLayout>
        ...
        <!-- Approve Dialog for Accommodation Claim -->
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start gap-3 p-3 border rounded-lg">
                    ...
                    <label for="officialBusiness" class="text-sm cursor-pointer">
                        <span class="font-medium">I confirm that this accommodation is for official business
                            purposes.</span>
                        <br>
                        <span class="text-xs text-gray-600 italic">
                            Saya mengesahkan bahawa penginapan ini adalah atas urusan rasmi.
                        </span>
                    </label>
                </div>
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-lg font-semibold text-gray-800">{{ claim.number_of_nights }}
                                            nights</p>
                                    </div>
                                </div>
                                ...
                                <div v-if="claim.hotel_city || claim.hotel_country"
                                ...
                                <div v-if="claim.destination_city || claim.destination_country"
                                    class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div v-if="claim.destination_country" class="space-y-1">
                                        <label class="block text-sm font-medium text-gray-600">Destination
                                            Country</label>
                                        <p class="text-lg font-semibold text-gray-800">{{ claim.destination_country }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            formatCurrency(claim.rate_per_night, claim.currency) }}/night</p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            formatCurrency(claim.subtotal_amount, claim.currency) }}</p>
                                    </div>
                                </div>

                                <!-- Tax and Service Charge -->
                                <div v-if="claim.tax_percentage || claim.service_charge_percentage"
                                    class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div v-if="claim.tax_percentage" class="space-y-1">
                                        <label class="block text-sm font-medium text-gray-600">Tax Percentage</label>
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            formatPercentage(claim.tax_percentage) }}</p>
                                    </div>
                                    <div v-if="claim.service_charge_percentage" class="space-y-1">
                                        <label class="block text-sm font-medium text-gray-600">Service Charge
                                            Percentage</label>
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            formatPercentage(claim.service_charge_percentage) }}</p>
                                    </div>
                                </div>

                                <div v-if="claim.tax_amount || claim.service_charge_amount"
                                    class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div v-if="claim.tax_amount" class="space-y-1">
                                        <label class="block text-sm font-medium text-gray-600">Tax Amount</label>
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            formatCurrency(claim.tax_amount, claim.currency) }}</p>
                                    </div>
                                    <div v-if="claim.service_charge_amount" class="space-y-1">
                                        <label class="block text-sm font-medium text-gray-600">Service Charge
                                            Amount</label>
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            formatCurrency(claim.service_charge_amount, claim.currency) }}</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="text-sm text-gray-600">
                                        ...
                                        <div class="space-y-1">
                                            <div class="flex justify-between">
                                                ...
                                                <span>{{ formatCurrency(claim.rate_per_night * claim.number_of_nights,
                                                    claim.currency) }}</span>
                                            </div>
                                            ...
                                            <div v-if="claim.service_charge_amount" class="flex justify-between">
                                                ...
                                                <span>{{ formatCurrency(claim.service_charge_amount, claim.currency)
                                                    }}</span>
                                            </div>
                        ...
                        <template #content>
                            <div class="space-y-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div v-if="claim.approver && (claim.status === 'approved' || claim.status === 'rejected')"
                        ...
                        <template #content>
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-medium">{{ formatCurrency(claim.rate_per_night,
                                        claim.currency) }}/night</span>
                                </div>
