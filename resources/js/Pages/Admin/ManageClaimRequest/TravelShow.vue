                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            getVehicleTypeDisplay(claim.vehicle_type) }}</p>
                                    </div>
                                    <div class="space-y-1">
                                        <label class="block text-sm font-medium text-gray-600">Registration
                                            Plate</label>
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            claim.registration_plate_number || '—' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            getCubicCapacityDisplay(claim.cubic_capacity) }}</p>
                                    </div>
                                    <div class="space-y-1">
                                        <label class="block text-sm font-medium text-gray-600">Multiple Days
                                            Trip</label>
                                        <p class="text-lg font-semibold text-gray-800">{{ claim.is_multiple_days ? 'Yes'
                                            : 'No' }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-lg font-semibold text-gray-800">{{
                                            getTripDuration(claim.date_of_travel, claim.end_date_of_travel,
                                                claim.is_multiple_days) }}</p>
                                    </div>
                                    <div class="space-y-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-lg font-semibold text-gray-800">{{ claim.travel_from || '—' }}
                                        </p>
                                    </div>
                                    <div class="space-y-1">
                                ...
                                <div v-for="(leg, index) in claim.travel_legs_data" :key="index"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <p class="text-sm font-semibold text-blue-600">{{ formatNumber(leg.distance)
                                                }} km</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <template #content>
                            <div class="space-y-4">
                                <div class="text-center">
                                    <p class="text-3xl font-bold text-blue-600">{{ formatCurrency(claim.total_cost) }}
                                    </p>
                                ...
                                <div class="p-3 bg-gray-50 rounded-lg">
                                    <div class="text-sm text-gray-600 text-center">
                                        ...
                                        {{ formatNumber(claim.total_distance) }} km × {{
                                            formatCurrency(claim.rate_per_km) }}/km = {{ formatCurrency(claim.total_cost) }}
                                    </div>
                                </div>
                            </div>
                        </template>
                        ...
                        <template #content>
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-medium">{{ getVehicleTypeDisplay(claim.vehicle_type)
                                        }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Registration:</span>
                                    <span class="text-sm font-medium">{{ claim.registration_plate_number || '—'
                                        }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Capacity:</span>
                                    <span class="text-sm font-medium">{{ getCubicCapacityDisplay(claim.cubic_capacity)
                                        }}</span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-lg font-bold text-blue-600">{{ formatCurrency(claim.total_cost)
                                        }}</span>
                                </div>
                            </div>
                        </template>
                        ...
                        <template #content>
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="font-medium">{{ claim.total_distance }} × {{ claim.rate_per_km
                                        }}</span>
                                </div>
                                <hr class="my-1">
